    ...
    _createClass(_class, [{
        ...
        value: function getImageCoordinates() {
            ...
            if (!lockImage || !this.oldCoords) {
                this.oldCoords = (0, _imageCoordinates.getLensModeEnlargedImageCoordinates)({
                    containerDimensions: containerDimensions,
        ...
        value: function render() {
            ...
            var component = _react2.default.createElement(
                'div',
                {
                    ...
                    style: _extends({}, this.containerStyle, { opacity: this.isVisible || this.props.lockImage ? 1 : 0 })
                },
                _react2.default.createElement('img', {
                    ...
                    style: _extends({}, this.imageStyle, { opacity: this.isVisible || this.props.lockImage ? 1 : 0 }),
                    onLoad: onLoad,
                    onError: onError
                })
            );
        ...
        get: function get() {
            ...
            return isTransitionEntering || isTransitionActive || isTransitionLeaving || this.props.lockImage;
        }
    }, {
        key: 'containerStyle',
        get: function get() {
